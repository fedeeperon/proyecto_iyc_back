...
describe('ImcRepository', () => {
    ...
    describe('createAndSave', () => {
        ...
        it('should throw InternalServerErrorException on error', async () => {
            ...
            await expect(repository.createAndSave(dto)).rejects.toThrow(
    ...
    describe('find', () => {
        ...
        it('should throw InternalServerErrorException on error', async () => {
            repo.find.mockRejectedValue(
                new Error('No se pudo obtener el historial de IMC'),
            );
            await expect(repository.find(true, 0, 10)).rejects.toThrow(
